	...
	private Ontology makeChangeToProcess(Ontology onto, JSONObject json) {
		try {
			...
			Individual mechanismsToEnsureProtectionOfDataIndividual = KAON2Manager.factory()
					.individual(URI + "#" + json.getString("mechanismsToEnsureProtectionOfData"));
			...
			Individual systematicDescriptionOfProcessingIndividual = KAON2Manager.factory()
					.individual(URI + "#" + json.getString("systematicDescriptionOfProcessing"));
			...
			Individual legitimateInterestOfProcessingIndividual = KAON2Manager.factory()
					.individual(URI + "#" + json.getString("legitimateInterestOfProcessing"));
			Individual assessmentOfNecessityOfProcessingIndividual = KAON2Manager.factory()
					.individual(URI + "#" + json.getString("assessmentOfNecessityOfProcessing"));
			Individual assessmentOfProportionalityOfProcessingIndividual = KAON2Manager.factory()
					.individual(URI + "#" + json.getString("assessmentOfProportionalityOfProcessing"));
			Individual assessmentOfRisksAndRightsToFreedomIndividual = KAON2Manager.factory()
					.individual(URI + "#" + json.getString("assessmentOfRisksAndRightsToFreedom"));
			changes.add(
			...
			ObjectProperty measuresToAddressRisksHasSecurityMeasures = KAON2Manager.factory()
					.objectProperty(URI + "#measuresToAddressRisksHasSecurityMeasures");
			ObjectProperty measuresToAddressRisksHasMechanismsToEnsureProtectionOfData = KAON2Manager.factory()
					.objectProperty(URI + "#measuresToAddressRisksHasMechanismsToEnsureProtectionOfData");
			...
			ObjectProperty DPIAHasAssessmentOfProportionalityOfProcessing = KAON2Manager.factory()
					.objectProperty(URI + "DPIAHasAssessmentOfProportionalityOfProcessing");
			ObjectProperty DPIAHasAssessmentOfRisksAndRightsToFreedom = KAON2Manager.factory()
					.objectProperty(URI + "DPIAHasAssessmentOfRisksAndRightsToFreedom");
			...
			// commercial interest, security of processing
			...
			changes.add(new OntologyChangeEvent(KAON2Manager.factory().objectPropertyRange(viewRisksCommercialInterest, commercialInterest),
					OntologyChangeEvent.ChangeType.ADD));
			changes.add(new OntologyChangeEvent(KAON2Manager.factory().objectPropertyDomain(viewRisksSecurityOfProcessing, view),
					OntologyChangeEvent.ChangeType.ADD));
			changes.add(new OntologyChangeEvent(KAON2Manager.factory().objectPropertyRange(viewRisksSecurityOfProcessing, securityOfProcessing),
					OntologyChangeEvent.ChangeType.ADD));
			...
			changes.add(new OntologyChangeEvent(KAON2Manager.factory().objectPropertyRange(measuresToAddressRisksHasSafeguard, safeguard),
					OntologyChangeEvent.ChangeType.ADD));
			changes.add(new OntologyChangeEvent(KAON2Manager.factory().objectPropertyDomain(measuresToAddressRisksHasSecurityMeasures, measuresToAddressRisks),
					OntologyChangeEvent.ChangeType.ADD));
			changes.add(new OntologyChangeEvent(KAON2Manager.factory().objectPropertyRange(measuresToAddressRisksHasSecurityMeasures, securityMeasures),
					OntologyChangeEvent.ChangeType.ADD));
			changes.add(new OntologyChangeEvent(
